...
triggers_1e_25ns = [ "HLT_Ele35_WPLoose_v*", "HLT_Ele25_eta2p1_WPTight_Gsf_v*", "HLT_Ele115_CaloIdVT_GsfTrkIdT_v*", "HLT_Ele27_WPTight_Gsf_v*", "HLT_Ele27_eta2p1_WPTight_Gsf_v*", "HLT_Ele22_WPLoose_Gsf_v*", "HLT_Ele27_WPLoose_Gsf_v*", "HLT_Ele32_WPTight_Gsf_v*", "HLT_Ele32_eta2p1_WP75_Gsf_v*", "HLT_Ele45_WPLoose_Gsf_v*"]
triggers_1e      = [ "HLT_Ele23_WPLoose_Gsf_v*", "HLT_Ele23_CaloIdL_TrackIdL_IsoVL_v*", "HLT_Ele27_WPLoose_Gsf_v*", "HLT_Ele27_eta2p1_WPLoose_Gsf_v*", "HLT_Ele32_eta2p1_WPLoose_Gsf_v*", "HLT_Ele27_WP85_Gsf_v*", "HLT_Ele27_eta2p1_WP75_Gsf_v*", "HLT_Ele32_eta2p1_WP75_Gsf_v*", "HLT_Ele45_WPLoose_Gsf_v*" ]
